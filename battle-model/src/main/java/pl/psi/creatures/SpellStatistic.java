...
public enum SpellStatistic implements SpellStatisticIf
{
    ...
    CREATE_TREE("Create tree", 0, 20, 0,0,0,0,0,5, "Create tree"),
    ...
    CREATE_SPIKES("Create spikes", 1, 20, 0,0,0,0,0,5, "Create spikes"),
    ...
    CREATE_BOULDER("Create boulder", 2, 20, 0,0,0,0,0,5, "to_delete"),
    ...
    CREATE_ROCK("Create rock", 3, 20, 0,0,0,0,0,5, "CREATE_ROCK")
    ;
